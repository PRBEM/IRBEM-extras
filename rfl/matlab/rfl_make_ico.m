...
inst_info.ELEC1.ELE.CROSSCALIB = 0.386435;
inst_info.ELEC1.ELE.CROSSCALIB_RMSE = 0.92801;
...
inst_info.ELEC2.ELE.CROSSCALIB = 0.275165;
inst_info.ELEC2.ELE.CROSSCALIB_RMSE = 1.02817;
...
inst_info.ELEC3.ELE.CROSSCALIB = 1.89545;
inst_info.ELEC3.ELE.CROSSCALIB_RMSE = 0.971318;
...
inst_info.ELEC4.ELE.CROSSCALIB = 1.83162;
inst_info.ELEC4.ELE.CROSSCALIB_RMSE = 0.79326;
...
inst_info.ELEC5.ELE.CROSSCALIB = 1.01426;
inst_info.ELEC5.ELE.CROSSCALIB_RMSE = 0.813318;
...
%         fprintf('inst_info.%s.ELE.CROSSCALIB = %g;\n',v,CROSSCALIB);
%         fprintf('inst_info.%s.ELE.CROSSCALIB_RMSE = %g;\n',v,db.rel_err(i));
